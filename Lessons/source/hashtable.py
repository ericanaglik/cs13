...
class HashTable(object):
    ...
    def length(self):
        ...
        Best and worst case running time: O(n) under what conditions? it traverses buckets linearly"""
    ...
    def delete(self, key):
        ...
        Best case running time: O(1) if the item doesnt exist
    ...
    def _resize(self, new_size=None):
        ...
        Best and worst case running time: O(n)/O(b) because we have to move things over potentially
