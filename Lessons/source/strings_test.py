...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_matching_patterns(self):
        ...
        assert contains('kevin', 'vi') is True
        assert contains('erica', 'eric') is True
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        assert contains('faith', 'cult') is False
        assert contains('faith', 'faiyh') is False
    ...
    def test_contains_with_complex_patterns(self):
        ...
        assert contains('heeloooloolo', 'ool') is True
    ...
    def test_find_index_with_complex_patterns(self):
        ...
        # TODO: Write more test cases that check complex patterns or edge cases
        # You'll need a lot more than this to test your algorithm's robustness
        assert find_index('iwannabedonewiththisassignmentfaithpls', 'th') == 0
        assert find_index('i am suffering its almost midnight', 'mid') == 21
    ...
    def test_find_all_indexes_with_non_matching_patterns(self):
        ...
        assert find_all_indexes('im so tired but i wanna pass this submission pls', 'awake') == []
        assert find_all_indexes('im such a procrastinator', 'good student') == []
    ...
    def test_find_all_indexes_with_complex_patterns(self):
        ...
        # TODO: Write more test cases that check complex patterns or edge cases
        # You'll need a lot more than this to test your algorithm's robustness
        assert find_all_indexes('iwannabedonewiththisassignmentfaithpls', 'th') == [14,16,34]
        assert find_all_indexes('suffefering', 'fer') == [5] # i tbh dont even know how to make a complex pattern im not creative enough right now im SORRY
